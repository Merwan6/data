...
"""#Code - jeu de data1
list_item_2 = getFromFile("data.csv")
list_item = [list(list_item_2)]
b = list_item[0][0]

freq = []
for k in range(len(list_item[0][0])) :
    freq.append(1)
   
c = constructTree(b, freq , 1)
print(c)"""
...
print(fpgrowthFromFile("kaggle.csv",0.2,0.2))